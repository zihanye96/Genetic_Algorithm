---
title: "Implementing a Genetic Algorithm for Variable Selection in Regression"
author: "Asem Berkalieva, Jing Xu, Zihan Ye"
date: "12/12/2019"
output: pdf_document
---
...
First, we test the type and format of the inputs and outputs for individual functions to make sure that they're what we expect them to be. Then, we test whether the individual functions works collabratively in the overall funcion "select". Finally, we test the overall "select" function with given datasets and expected outputs, and test whether or not it works with standard input, with a subset of the available covariates, with a non-linear form of regression (ex. logistic), and that the model won't include a covariate that has low correlation with the response variable.
